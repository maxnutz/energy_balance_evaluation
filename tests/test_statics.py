...
class TestStaticsDataStructures(unittest.TestCase):
    ...
    def test_statics_are_not_modifiable(self):
        ...
        from energy_balance_evaluation.statics import (
            non_numerical_columns_list as list1,
        )
...
class TestStaticsIntegration(unittest.TestCase):
    ...
    def test_no_empty_statics(self):
        ...
        self.assertTrue(
            len(non_numerical_columns_list) > 0, "non_numerical_columns_list is empty"
        )
        self.assertTrue(
            len(eb_row_string_replacement_dict) > 0,
            "eb_row_string_replacement_dict is empty",
        )
